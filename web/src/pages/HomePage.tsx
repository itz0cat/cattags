      ...
      <section className="relative text-center max-w-4xl mx-auto px-4 pt-10">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3 sm:gap-4">
          <button
            ...
            className="flex items-center space-x-2 px-6 py-3 rounded-lg bg-[#22C55E] hover:bg-[#16A34A] text-white font-semibold shadow-lg shadow-[#22C55E]/20 transition-all hover:scale-[1.02] cursor-pointer"
          >
